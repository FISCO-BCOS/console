...
public class AccountTools {
    ...
    public static Account newAccount()
        ...
        if (logger.isDebugEnabled()) {
            int type = getPrivateKeyType((ECPrivateKey) keyPair.getPrivate());
    ...
    public static Account loadAccount(String accountPath, String password)
        ...
        if (accountPath.endsWith("p12")) {
            ...
            keyPair = new KeyPair(p12Manager.getPublicKey(), p12Manager.getPrivateKey());
            ...
            keyPair = new KeyPair(pem.getPublicKey(), pem.getPrivateKey());

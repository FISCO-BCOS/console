...
public class AccoutUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //       System.out.println("Wallet file " + walletFileName + " successfully created in: " +
        // destinationDir + "\n");
        ...
        Credentials loadCredentials =
                WalletUtils.loadCredentials(
                        password2,
                        "key/UTC--2019-04-07T15-01-48.346000000Z--53d3c2bbac439d750151acdc2be8b2736104e224.json");
